...
import { type Crypto } from '@/lib/api/coinbase';
...
const ensureBitcoinFirst = (cryptos: Crypto[]) => {
  const bitcoinIndex = cryptos.findIndex(crypto => 
    crypto.symbol.toUpperCase() === 'BTC' || crypto.name.toLowerCase() === 'bitcoin'
  );
...
const generateChartData = (crypto: Crypto) => {
  ...
  return crypto.sparkline.map(price => ({
        ...
        <Table>
          <TableHeader className="sticky top-0 bg-background z-10">
            <TableRow>
              ...
              <TableHead className="w-[150px] text-center">24h Change</TableHead>
              <TableHead className="w-[150px] text-center">Market Cap</TableHead>
              <TableHead className="w-[150px] text-center">Volume (24h)</TableHead>
            </TableRow>
          </TableHeader>
              ...
              return (
                <TableRow
                  ...
                  style={{
                    ...
                    width: "100%",
                    display: "grid",
                    gridTemplateColumns: "80px 250px 200px 150px 150px 150px 150px",
                    alignItems: "center"
                  }} 
                  className="cursor-pointer hover:bg-muted/50"
                  onClick={() => onSelect(crypto)}>
                  <TableCell className="flex items-center justify-center">{virtualRow.index + 1}</TableCell>
                  <TableCell>
                    ...
                    <div className="w-[120px] h-[40px]">
                      ...
                      >
                        <Line
                          type="monotone"
                          dataKey="value"
                          stroke={crypto.price_change_24h >= 0 ? '#22c55e' : '#ef4444'}
                          strokeWidth={1.5}
                          dot={false}
